...
class Chain:
    ...
    def _flag_unattributable_zero(self, project: dict, flow_metric: str, stock_metric: str, when, out):
        ...
        # anomalies this flag exists to raise. A zero on a daily burn is a burn that did not
        # happen, a read that did not advance, or two reads too close together to span one burn.
